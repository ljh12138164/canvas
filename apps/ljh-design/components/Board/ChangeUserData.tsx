...
// const ChangeUserData = ({ data }: { data: User }) => {
...
//     <ScrollArea>
//       <form
//         onSubmit={handleSubmit(hanldersSubmit)}
//         className="flex flex-col gap-5 px-2 py-4"
//       >
//         <Card>
//           <CardHeader>
...
//         </Card>
//         <Separator />
//         <div className="flex justify-end gap-2 w-full h-full">
//           <Button
//             className="flex-1 md:flex-none md:w-[150px]"
//             variant="outline"
//             onClick={() => {
//               reset();
//               setRepetPassword("");
...
//             重置全部
//           </Button>
//           <Button type="submit" className="flex-1 md:flex-none md:w-[150px]">
//             保存
//           </Button>
//         </div>
//       </form>
