...
<template>
  <Toaster />
  <main
    class="w-full h-[100dvh] grid grid-cols-1 md:grid-cols-2 justify-center items-center entryf"
  >
    <div
      class="relative h-full hidden flex-col bg-muted p-10 text-white dark:border-r md:block"
    >
            ...
            <div class="grid gap-4">
              <div v-if="!isLogin">
                ...
                <Input
                  ...
                  minlength="3"
                  maxlength="10"
                  class="dark:placeholder:text-black"
                  :disabled="isLoading"
                />
              </div>
